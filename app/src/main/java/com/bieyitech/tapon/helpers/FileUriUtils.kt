    ...
    companion object {
        fun getFilePathByUri(context: Context, uri: Uri?): String?{
            ...
            if(ContentResolver.SCHEME_FILE == uri.scheme){
                ...
                }else if(isFileExplorerDocument(uri)){
                    // 从“文件管理”中选择文件
                    path = uri.path?.replace("external_files", "storage/emulated/0")
                }
            }
            return path
        }
        ...
        private fun isFileExplorerDocument(uri: Uri): Boolean =
            "com.android.fileexplorer.myprovider" == uri.authority
